...
public class TableModelManager {
    ...
    private static final TableFrameModel WHITE_LIST_PLAYERS_FRAME;
    ...
    static {
        ...
        WHITE_LIST_PLAYERS_FRAME = new TableFrameModel();
        WHITE_LIST_PLAYERS_FRAME.setFrameTitle("List of allowed players on server");
        WHITE_LIST_PLAYERS_FRAME.setFrameBoxLabel("Command result:");
        WHITE_LIST_PLAYERS_FRAME.setFrameFilterTooltip(
            "Filter the players in white list (Regular expressions can be used)");
        WHITE_LIST_PLAYERS_FRAME.setFrameHeaderLabel(
            "List of allowed players on server:");

        CustomTableModel opPlayersTableModel = new PlayersTableModel();
        WHITE_LIST_PLAYERS_FRAME.setModel(opPlayersTableModel);
        WHITE_LIST_PLAYERS_FRAME.setTable(new CustomTable(opPlayersTableModel));
    }
    ...
    public static TableFrameModel getWhiteListPlayersFrame() {
        return WHITE_LIST_PLAYERS_FRAME;
    }
}
