...
public class MainFrame extends javax.swing.JFrame {
	...
	public MainFrame(String host, int port, String password, String... args)
		...
		for (String command : CommandsUtils.getAvailableCommands()) {
			((CommandsTableModel) this.commandsList.getModel()).addRow(command);
		}
	...
	private void initComponents() {
		...
		commandsFrame.setPreferredSize(new java.awt.Dimension(480, 400));
		commandsFrame.setType(java.awt.Window.Type.POPUP);

		availableCommandsLabel
				.setFont(new java.awt.Font("Miriam Fixed", 1, 14)); // NOI18N
		...
		commandsList.setBorder(javax.swing.BorderFactory
		...
		commandsList.setFont(new java.awt.Font("Miriam Fixed", 0, 12)); // NOI18N
		...
		commandsList.getTableHeader().setFont(
				new java.awt.Font("Miriam Fixed", Font.BOLD, 14));
		...
		commandHelpPane.setBorder(javax.swing.BorderFactory
				.createBevelBorder(javax.swing.border.BevelBorder.LOWERED));
		...
		commandHelpPane.setCursor(new java.awt.Cursor(
		...
		jLabel1.setText("Command help:");

		closeCommandsList.setFont(new java.awt.Font("Miriam Fixed", 1, 14)); // NOI18N
		...
		javax.swing.GroupLayout commandsFrameLayout = new javax.swing.GroupLayout(
				commandsFrame.getContentPane());
		commandsFrame.getContentPane().setLayout(commandsFrameLayout);
		commandsFrameLayout
				.setHorizontalGroup(commandsFrameLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								commandsFrameLayout
										...
										.addContainerGap()));
		commandsFrameLayout
				.setVerticalGroup(commandsFrameLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								commandsFrameLayout
										...
										.addPreferredGap(
												javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
										.addComponent(closeCommandsList)
										.addContainerGap()));
		...
		commandsListItem.setAccelerator(javax.swing.KeyStroke.getKeyStroke(
		...
		commandsListItem
				.setIcon(new javax.swing.ImageIcon(
						getClass()
								.getResource(
										"/fr/nemolovich/apps/minecraftrcon/gui/icon/commandsList.png"))); // NOI18N
