...
public class MainFrame extends javax.swing.JFrame {
    ...
    static {
        ...
        StyleConstants.setForeground(FINE_STYLE, Color.decode("#00AA00"));
        ...
        for (MinecraftColors color : MinecraftColorsUtil.getColors()) {
            style = sc.addStyle(color.getName().toUpperCase().concat("_STYLE"),
                DEFAULT_STYLE);
            StyleConstants.setForeground(style, Color.decode(
    ...
    public MainFrame(ClientSocket socket) {
        ...
        CommandsUtils
            .addCommand(new CommandAdapter("/colors", "Display minecraft colors") {
                @Override
                public String doCommand(String... args) {
                    for (MinecraftColors color : MinecraftColorsUtil.getColors()) {
        ...
        this.fine(String.format(
            "Connection succeed! Welcome on Nemolovich Minecraft RCON Administration%n"));
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(4, 4, 4)
                .addComponent(outputScroll, javax.swing.GroupLayout.DEFAULT_SIZE, 412, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            ...
            if (!message.startsWith("/") & message.contains(
                ...
                for (String part : parts) {
                    if (!part.isEmpty()) {
                        ...
                        if (color != null) {
                            Style mcStyle = sc.getStyle(
                                color.getName().toUpperCase().concat("_STYLE"));
                            if (mcStyle != null) {
                                colorStyle = mcStyle;
                            }
                        }
    ...
    private void playersButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_playersButtonActionPerformed
        try {
            ...
            LOGGER.error("Can not retrieve players list", ex);
        }
    }//GEN-LAST:event_playersButtonActionPerformed

    private void stopButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_stopButtonActionPerformed
        if (JOptionPane.showConfirmDialog(this,
            "Do you really want to stop the server?", "Stop the server? :o",
            ...
            try {
                ...
                LOGGER.error("Can not stop the server", ex);
            }
        }
